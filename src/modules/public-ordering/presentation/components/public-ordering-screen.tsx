...
export function PublicOrderingScreen({ qrToken }: { qrToken: string }) {
  ...
  return (
    <main className="min-h-screen bg-[var(--color-background)] px-2 py-2 text-white sm:px-4 sm:py-5">
      <div className="app-shell-mobile mx-auto grid w-full gap-4 sm:gap-5 xl:max-w-7xl xl:grid-cols-[minmax(0,1fr)_380px]">
        <section className="section-grid gap-5">
          <div className="dark-panel rounded-[28px] border border-white/10 p-4 sm:rounded-[34px] sm:p-5">
            <div className="flex flex-col gap-4">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <h1 className="text-[2rem] leading-tight font-semibold sm:text-3xl">
          ...
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
            {filteredProducts.map((product) => (
              <Card
                key={product.id}
                className="rounded-[28px] border border-[var(--color-border)] bg-[var(--color-surface)] p-3 text-[var(--color-ink)] shadow-none sm:p-4"
              >
                <ProductVisual
          ...
          <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_320px]">
            <Card className="rounded-[28px] border border-[var(--color-border)] bg-[var(--color-surface)] p-4 text-[var(--color-ink)] shadow-none sm:rounded-[32px] sm:p-5">
        ...
        <aside className="dark-panel h-fit rounded-[28px] border border-white/10 p-4 sm:rounded-[34px] sm:p-5 xl:sticky xl:top-5">
          <div className="grid gap-4">
            <div>
